...
def SportsDevil():
    print "SportsDevil"
    url = "https://github.com/wakeras/KODIM/raw/master/kodirepo/plugin.video.SportsDevil/plugin.video.SportsDevil-2017.06.30.NL.zip"
...
def PleXus():
    print "PleXus"
    url = "https://github.com/ares-fortress/repo/raw/master/program.plexus/program.plexus-0.1.7.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'pxus.zip')
...
def URLResolver():
    print "URLResolver"
    url = "https://github.com/wakeras/KODIM/raw/master/kodirepo/script.module.urlresolver/script.module.urlresolver-4.0.04.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'urx.zip')
...
def GDrive():
    print "GDrive"
    url = "https://github.com/wakeras/KODIM/raw/master/kodirepo/plugin.video.gdrive/plugin.video.gdrive-0.8.52.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'gdr.zip')
...
def Dutch():
    ...
    url = "http://repo.ares-project.com/tools/repository.shani-2.9.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
...
def BS():
    print "BS"
    url = "https://ftp.acc.umu.se/mirror/xbmc.org/addons/krypton/script.module.beautifulsoup/script.module.beautifulsoup-3.2.1.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'smbs.zip')
...
def SMSD():
    print "SMSD"
    url = "https://ftp.acc.umu.se/mirror/xbmc.org/addons/krypton/script.module.simple.downloader/script.module.simple.downloader-1.9.5.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'smsd.zip')
...
def BS4():
    print "BS4"
    url = "https://ftp.acc.umu.se/mirror/xbmc.org/addons/krypton/script.module.beautifulsoup4/script.module.beautifulsoup4-4.3.2.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'bs4.zip')
...
def SMR():
    print "SMR"
    url = "https://ftp.acc.umu.se/mirror/xbmc.org/addons/krypton/script.module.requests/script.module.requests-2.12.4.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'smr.zip')
...
def SMHL2():
    print "SMHL2"
    url = "https://ftp.acc.umu.se/mirror/xbmc.org/addons/krypton/script.module.httplib2/script.module.httplib2-0.8.0.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'smhl2.zip')
...
def SMLR():
    print "SMLR"
    url = "https://github.com/wakeras/repo/raw/master/script.module.liveresolver/script.module.liveresolver-0.1.49.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'smlr.zip')
...
def SMYDLL():
    print "SMYDLL"
    url = "https://ftp.acc.umu.se/mirror/xbmc.org/addons/krypton/script.module.youtube.dl/script.module.youtube.dl-17.709.0.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'smydll.zip')
...
def PVY():
    print "PVY"
    url = "https://github.com/wakeras/KODIM/raw/master/kodirepo/plugin.video.youtube/plugin.video.youtube-5.4.14Bump.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'pvy.zip')
...
def SMSJ():
    print "SMSJ"
    url = "https://ftp.acc.umu.se/mirror/xbmc.org/addons/krypton/script.module.simplejson/script.module.simplejson-3.3.0.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'smsj.zip')
...
def SMLS():
    print "SMLS"
    url = "https://ftp.acc.umu.se/mirror/xbmc.org/addons/krypton/script.module.livestreamer/script.module.livestreamer-1.12.0.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'smls.zip')
...
def SMPYAMF():
    print "SMPYAMF"
    url = "https://github.com/wakeras/repo/raw/master/script.module.pyamf/script.module.pyamf-0.6.2.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'smpyamf.zip')
...
def SMAC():
    print "SMAC"
    url = "https://github.com/wakeras/KODIM/raw/master/kodirepo/script.module.addon.common/script.module.addon.common-2.0.1.1.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'smac.zip')
...
def Repo():
    if os.path.exists(os.path.join(xbmc.translatePath("special://home/addons/").decode("utf-8"), 'repository.aresproject')):
        return
        
    url = "https://github.com/ares-fortress/repo/raw/master/repository.aresproject/repository.aresproject-0.1.0.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'isr.zip')
...
addon = xbmcaddon.Addon('plugin.video.aresmusic')
...
exec base64.b64decode('U09VUkNFUyA9IFt7InVybCI6ICJodHRwOi8vbXVzaWMuYXJlc2hvc3Q2LnNlZWRyLmlvL21haW4ueG1sIiwgImZhbmFydCI6ICJodHRwczovL3MyNi5wb3N0aW1nLm9yZy9ma3lhazZ4ODkvcmFkaW8uanBnIn1d')

exec base64.b64decode('I2Zyb2RvDQojZGF1ZA0KI3NhbSBzZW5nDQojY2FyaSBwYWFhPw==')


def krypton ( fix ) :
 fix = fix . replace ( '}' , '' ) . replace ( '{' , '' ) . replace ( ',' , '' ) . replace ( ']' , '' ) . replace ( '[' , '' )
 fix = fix . decode ( 'base64' )
 return fix

exec base64.b64decode('I2NhcmkgcGFhYT8NCiNmcm9kbw0KI2RhdWQNCiNzYW0gc2VuZw0K')


def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.aresmusic-%s]: %s" %(addon_version, string))
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("aresmusic,XBMC.Notification(We failed with error code - "+str(e.code)+",10000,"+icon+")")
            elif hasattr(e, 'reason'):
                addon_log('We failed to reach a server.')
                addon_log('Reason: %s' %e.reason)
                xbmc.executebuiltin("XBMC.Notification(aresmusic,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")
	...
	try:
		if os.path.exists(favorites) == True:
			...
			if FAV == "[]":
				...
				addDir('[COLOR blue][B]- MY FAVORITE CHANNELS[/COLOR][/B]','url',4,os.path.join(home, 'resources', 'favorite.png'),FANART,'','','','')
				addDir('','',100,'',FANART,'','','','')
...
def addSource(url=None):
        ...
        xbmc.executebuiltin("XBMC.Notification(aresmusic,New source added.,5000,"+icon+")")
        if not url is None:
...
def getSoup(url,data=None):
        ...
        if url.startswith('http://') or url.startswith('https://'):
            ...
            exec base64.b64decode('I2NhcmkgcGFhYT8NCiNmcm9kbw0KI2RhdWQNCiNzYW0gc2VuZw0KIw0KIw0KI3RhayBkYWsgYXBhIHBhIHNpbmkNCg==')
                ...
                if len(item('link')) >0:
                    ...
                    for i in item('imdb'):
                        ...
                        for i in item('f4m'):
                            ...
                            url.append(f4m)
                elif len(item('acestream')) >0:
                    for i in item('acestream'):
                        if not i.string == None:
                            acestream = 'plugin://program.plexus/?url='+urllib.quote_plus(i.string)+'&mode=1&name=acestream'
                            url.append(acestream)                            
                elif len(item('gdrive')) >0:
                    for i in item('gdrive'):
                        if not i.string == None:
                            gdrive = 'plugin://plugin.video.gdrive?mode=streamURL&amp;url='+urllib.quote_plus(i.string)+'view'
                            url.append(gdrive)                            
                elif len(item('kepalabanar')) >0:
                    for i in item('kepalabanar'):
                        if not i.string == None:
                            kepalabanar = 'plugin://plugin.video.gdrive?mode=streamURL&amp;url=https://drive.google.com/file/d/'+urllib.quote_plus(i.string)+'/view'
                            url.append(kepalabanar)                            
                elif len(item('guc')) >0:
                    for i in item('guc'):
                        if not i.string == None:
                            guc = 'http://lh3.googleusercontent.com/'+urllib.quote_plus(i.string)
                            url.append(guc)                                    
                elif len(item('ftv')) >0:
                    for i in item('ftv'):
                        if not i.string == None:
                ...
                if len(url) > 1:
                    ...
                    if isXMLSource:
                            if not regexs == None: #<externallink> and <regex>
                                ...
                                #addLink(url[0],name.encode('utf-8', 'ignore')+  '[COLOR blue]build XML[/COLOR]',thumbnail,fanArt,desc,genre,date,True,None,regexs,total)
                            else:
...
def playmediawithproxy(media_url, name, iconImage,proxyip,port, proxyuser=None, proxypass=None): #jairox
    ...
    if media_url==None or media_url=='':
        xbmc.executebuiltin("XBMC.Notification(aresmusic,Unable to play empty Url,5000,"+icon+")")
        return
        ...
        try:
            while player.is_active:
                ...
                if player.urlplayed==False and time.time()-beforestart>12:
                    print 'failed!!!'
                    xbmc.executebuiltin("XBMC.Notification(aresmusic,Unable to play check proxy,5000,"+icon+")")
                    break
                #xbmc.sleep(1000)
        except: pass
...
def urlsolver(url):
    ...
    if host:
        ...
        xbmc.executebuiltin("XBMC.Notification(aresmusic,Urlresolver do not support this domain. - ,5000)")
        resolver=url
    return resolver
...
def download_file(name, url):
        if addon.getSetting('save_location') == "":
            xbmc.executebuiltin("XBMC.Notification('aresmusic','Choose a location to save files.',15000,"+icon+")")
            addon.openSettings()
        params = {'url': url, 'download_path': addon.getSetting('save_location')}
        downloader.download(name, params)
        dialog = xbmcgui.Dialog()
        ret = dialog.yesno('aresmusic', 'Do you want to add this file as a source?')
        if ret:
...
#            print 'parentalblockedpin',parentalblockedpin
            ...
            if showcontext == 'source':
                ...
                contextMenu.append(('Remove from aresmusic Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
            ...
            if showcontext == '!!update':
                ...
                contextMenu.append(('[COLOR blue]!!update[/COLOR]','XBMC.RunPlugin(%s)' %fav_params2))
            if not name in FAV:
                contextMenu.append(('Add to aresmusic Favorites','XBMC.RunPlugin(%s?mode=5&name=%s&url=%s&iconimage=%s&fanart=%s&fav_mode=%s)'
...
#                print 'setting as folder in link'
        ...
        if showcontext:
            ...
            if showcontext == 'fav':
                contextMenu.append(
                    ('Remove from aresmusic Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
                     %(sys.argv[0], urllib.quote_plus(name)))
                     )
                ...
                contextMenu.append(('Add to aresmusic Favorites','XBMC.RunPlugin(%s)' %fav_params))
            liz.addContextMenuItems(contextMenu)
        try:
...
#            ln+='</item>'
        ...
        if not (regexs and 'notplayable' in regexs and not url):        
            if url:
                ...
                xbmc.executebuiltin("XBMC.Notification(aresmusic,Failed to extract regex. - "+"this"+",4000,"+icon+")")
elif mode==18:
    addon_log("youtubedl")
    try:
        import youtubedl
    except Exception:
        xbmc.executebuiltin("XBMC.Notification(aresmusic,Please [COLOR blue]install Youtube-dl[/COLOR] module ,10000,"")")
    ...
    if not (keyboard.isConfirmed() == False):
        ...
        if newStr==parentalblockedpin:
            ...
            xbmc.executebuiltin("XBMC.Notification(aresmusic,Parental Block Disabled,5000,"+icon+")")
        else:
            xbmc.executebuiltin("XBMC.Notification(aresmusic,Wrong Pin??,5000,"+icon+")")
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
elif mode==56:
    addon_log("disable lock")
    addon.setSetting('parentalblocked', "true")
    xbmc.executebuiltin("XBMC.Notification(aresmusic,Parental block enabled,5000,"+icon+")")
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
