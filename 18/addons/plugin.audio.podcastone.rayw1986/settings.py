...
ADDON = xbmcaddon.Addon(id='plugin.audio.podcastone.rayw1986')
DATA_PATH = os.path.join(xbmc.translatePath('special://profile/addon_data/plugin.audio.podcastone.rayw1986'), '')
def addon():
    return ADDON
