...
class MyWindowCountDown(xbmcgui.WindowDialog):
	...
	def __init__(self,bgArt='',L=0,T=0,W=1280,H=720):
		...
		self.BG=xbmcgui.ControlImage(300,150,600,400,'http://cliqaddon.com/icon.png',aspectRatio=0); 
...
def do_My_Splash(img='http://cliqaddon.com/icon.png',HowLong=10,resize=False,L=0,T=0,W=1280,H=720): #HowLong in seconds.
