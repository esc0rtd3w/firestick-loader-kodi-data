...
class info():
    def __init__(self):
    	self.mode = 'fullmatchtv_motor'
        self.name = 'fullmatchtv.com Motorsports'
...
class main():
	...
	def __init__(self,url = 'http://fullmatchtv.com/motorsports'):
	...
	def get_post(self):
		content = client.request('http://fullmatchtv.com/motorsports',referer=self.base)
