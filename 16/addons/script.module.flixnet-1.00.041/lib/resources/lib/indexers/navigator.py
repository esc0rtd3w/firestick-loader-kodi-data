...
class navigator:
    def root(self):
        self.addDirectoryItem('Created by Flixnet', 'ShowChangelog', 'icon.png', 'DefaultFolder.png')
        self.addDirectoryItem('Set Custom Viewtype', 'viewsNavigator', 'icon.png', 'DefaultAddonProgram.png')
