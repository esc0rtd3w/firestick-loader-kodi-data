...
autoupdates.addon_id_name ='plugin.video.frightpix'
autoupdates.addon_xml_loca = "https://offshoregit.com/Blazetamer/repo/raw/master/plugin.video.frightpix/addon.xml"
autoupdates.addon_name ="FrightPix"
autoupdates.addon_zip_loca ="https://offshoregit.com/Blazetamer/repo/raw/master/zips/plugin.video.frightpix"
...
def getSources():
    ilist = []
    html = getRequest('http://www.popcornflixkids.com')
...
def getMovies(url):
    ...
    ilist =[]
    cat_url = 'http://www.popcornflixkids.com%s' % (url)
