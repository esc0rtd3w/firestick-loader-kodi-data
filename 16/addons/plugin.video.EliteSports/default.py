...
Q1RWQmFzZQ0K = base64.b64decode('aHR0cDovL3Bhc3RlYmluLmNvbS9yYXcucGhwP2k9cjd5YTZRaXc=')
addon = xbmcaddon.Addon('plugin.video.EliteSports')
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.live.EliteSports-%s]: %s" %(addon_version, string))
