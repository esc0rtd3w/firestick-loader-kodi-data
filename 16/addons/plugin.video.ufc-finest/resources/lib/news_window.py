...
def Dialog_Example():
    ...
    main_text = mytext
    my_buttons = ['Close']
    my_choice = koding.Custom_Dialog(main_content=main_text,pos='center',size='900x600',buttons=my_buttons,transparency=90,highlight_color='white',header='[B][COLOR white]Planet[/COLOR] [COLOR red]MMA[/COLOR] [COLOR white]News[/COLOR] [COLOR red]&[/COLOR] [COLOR white]Updates[/COLOR][/B]')
    if my_choice == 0: 
        return