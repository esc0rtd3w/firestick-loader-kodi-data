    ...
    try:
        if display_menu == True:
            if enable_newswin == 'true':
                koding.Add_Dir(name='[B][COLOR red]![/COLOR][COLOR white]Latest[/COLOR] [COLOR red]PMMA[/COLOR] [COLOR white]News[/COLOR] [COLOR red]And[/COLOR] [COLOR white]Updates[/COLOR][COLOR red]![/COLOR][/B]', url='{"my_text":"Latest News[CR]!!!","my_desc":""}', mode='dialog_example', folder=False, icon=os.path.join(art_path,'icon.png'), fanart=os.path.join(art_path,'fanart.jpg'))
