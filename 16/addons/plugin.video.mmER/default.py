...
addon_id = 'plugin.video.mmER'
plugin = xbmcaddon.Addon(id=addon_id)
DB = os.path.join(xbmc.translatePath("special://database"), 'mmER.db')
net = Net()
addon = Addon('plugin.video.mmER', sys.argv)
BASE_URL = 'http://www.filmon.in/'
...
def GetTitles(section, url, startPage= '1', numOfPages= '1'): 
        ...
        for page in range( start, end):
                if ( page != start):
                        ...
                        html = net.http_GET(pageUrl).content                      
                match = re.compile('class="item">\s*?<a href="(.+?)">\s*?<div class="image">\s*?<img src="(.+?)" alt="(.+?)"', re.DOTALL).findall(html)
...
def GetLinks(section, url, img, text):
        ...
        match4 = re.compile('<IFRAME SRC="(.+?)"').findall(content)
        match1 = re.compile('<meta property="og:description" content="(.+?)" />').findall(content)
        match2 = re.compile('<span class="dato"><a href="http://www.imdb.com/title/.+?" rel="nofollow" target="_blank">(.+?)</a> <b>(.+?)</b>').findall(content)
        ...
        for url in match + match3 + match4:
                host = GetDomain(url)
...
def MainMenu():   
        addon.add_directory({'mode': 'GetTitles', 'section': 'ALL', 'url': BASE_URL + '/',
                             'startPage': '1', 'numOfPages': '1'}, {'title':  '[B]Latest Movies[/B]'}, img=IconPath + 'icon.png', fanart= 'http://www.htbackdrops.org/v2/albums/userpics/10097/orig_oefg_kino_im_kesselhaus.jpg')
        addon.add_directory({'mode': 'GetTitles', 'section': 'ALL', 'url': BASE_URL + '/category/hollywood-movies/',
                             'startPage': '1', 'numOfPages': '1'}, {'title':  '[B]Latest Hollywood[/B]'}, img=IconPath + 'icon.png', fanart= 'http://www.htbackdrops.org/v2/albums/userpics/10097/orig_oefg_kino_im_kesselhaus.jpg')
        addon.add_directory({'mode': 'GetTitles', 'section': 'ALL', 'url': BASE_URL + '/category/bollywood-movies/',
                             'startPage': '1', 'numOfPages': '1'}, {'title':  '[B]Latest Bollywood[/B]'}, img=IconPath + 'icon.png', fanart= 'http://www.htbackdrops.org/v2/albums/userpics/10097/orig_oefg_kino_im_kesselhaus.jpg')
        addon.add_directory({'mode': 'GetTitles', 'section': 'ALL', 'url': BASE_URL + '/category/french-movies/',
                             'startPage': '1', 'numOfPages': '1'}, {'title':  '[B]Latest French[/B]'}, img=IconPath + 'icon.png', fanart= 'http://www.htbackdrops.org/v2/albums/userpics/10097/orig_oefg_kino_im_kesselhaus.jpg')

        addon.add_directory({'mode': 'GenreMenu'}, {'title':  '[B]Movies by genre[/B]'}, img=IconPath + 'icon.png', fanart= 'http://www.htbackdrops.org/v2/albums/userpics/10097/orig_oefg_kino_im_kesselhaus.jpg')
        addon.add_directory({'mode': 'YearMenu'}, {'title':  '[B]Movies by year[/B]'}, img=IconPath + 'icon.png', fanart= 'http://www.htbackdrops.org/v2/albums/userpics/10097/orig_oefg_kino_im_kesselhaus.jpg')

        addon.add_directory({'mode': 'GetSearchQuery'},  {'title':  '[COLOR green]Search[/COLOR]'}, img=IconPath + 'icon.png', fanart= 'http://www.htbackdrops.org/v2/albums/userpics/10097/orig_oefg_kino_im_kesselhaus.jpg')
        addon.add_directory({'mode': 'ResolverSettings'}, {'title':  '[COLOR red]Resolver Settings[/COLOR]'}, img=IconPath + 'url1.png', fanart= 'http://www.htbackdrops.org/v2/albums/userpics/10097/orig_oefg_kino_im_kesselhaus.jpg')
...
def GenreMenu(): 
        ...
        addon.add_directory({'mode': 'GetTitles', 'section': 'ALL', 'url': BASE_URL + '/category/biography/',
                             'startPage': '1', 'numOfPages': '1'}, {'title':  '[COLOR lime]biography [/COLOR] >>'}, img=IconPath + 'icon.png', fanart= 'http://www.hdesktops.com/wp-content/uploads/2013/12/purple-3d-abstract-wallpaper-desktop-background-171.jpg')
        ...
        addon.add_directory({'mode': 'GetTitles', 'section': 'ALL', 'url': BASE_URL + '/category/foreign/',
                             'startPage': '1', 'numOfPages': '1'}, {'title':  '[COLOR lime]foreign [/COLOR] >>'}, img=IconPath + 'icon.png', fanart= 'http://www.hdesktops.com/wp-content/uploads/2013/12/purple-3d-abstract-wallpaper-desktop-background-171.jpg')
        ...
        addon.add_directory({'mode': 'GetTitles', 'section': 'ALL', 'url': BASE_URL + '/category/sport/',
                             'startPage': '1', 'numOfPages': '1'}, {'title':  '[COLOR lime]sport [/COLOR] >>'}, img=IconPath + 'icon.png', fanart= 'http://www.hdesktops.com/wp-content/uploads/2013/12/purple-3d-abstract-wallpaper-desktop-background-171.jpg')
        ...
        addon.add_directory({'mode': 'GetTitles', 'section': 'ALL', 'url': BASE_URL + '/category/tv-movie/',
                             'startPage': '1', 'numOfPages': '1'}, {'title':  '[COLOR lime]tv movie [/COLOR] >>'}, img=IconPath + 'icon.png', fanart= 'http://www.hdesktops.com/wp-content/uploads/2013/12/purple-3d-abstract-wallpaper-desktop-background-171.jpg')
...
def Search(query):
        url = 'http://www.filmon.in/?s=' + query
        url = url.replace(' ', '+')
        print url
        html = net.http_GET(url).content
        match = re.compile('<div id="mt.+?" class="item">\s*?<a href="(.+?)">\s*?<div class="image">\s*?<img src="(.+?)" alt="(.+?)" width="100%" height="100%" />').findall(html)
