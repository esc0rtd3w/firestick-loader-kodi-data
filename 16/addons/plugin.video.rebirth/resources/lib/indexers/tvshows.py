...
class tvshows:
    ...
    def networks(self):
        ...
        ('DC Universe', '/webchannels/187/dc-universe'),
        ...
        ('Fox Reality', '/networks/1061/fox-reality-channel'),
        ('Fuse TV', '/networks/186/fuse-tv'),
        ('FOX', '/networks/4/fox'),
        ('FOX Sports 1', '/networks/95/fox-sports-1'),
        ('FOX Sports 2', '/networks/386/fox-sports-2'),		
        ('FX', '/networks/13/fx'),
        ('FXX', '/networks/47/fxx'),
        ...
        ('H2', '/networks/640/h2'),		
        ('Horror Channel', '/networks/605/horror-channel'),		
        ('HULU', '/webchannels/2/hulu'),		
        ('IFC', '/networks/65/ifc'),
        ('ID', '/networks/89/investigation-discovery'),
        ('ION', '/networks/194/ion-television'),
        ('Irish TV', '/networks/1081/irish-tv'),		
        ('ITV', '/networks/35/itv'),
        ('ITV2', '/networks/54/itv2'),
        ('ITV3', '/networks/550/itv3'),
        ('ITV4', '/networks/310/itv4'),		
        ('ITV Be', '/networks/551/itv-be'),
        ('ITV Encore', '/networks/549/itv-encore'),		
        ...
        ('NHL Network', '/networks/516/nhl-network'),	
