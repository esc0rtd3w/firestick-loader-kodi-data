...
class sources:
    ...
    def getSources(self, title, year, imdb, tvdb, season, episode, tvshowtitle, premiered, presetDict=[], timeout=30):
        ...
        if content == 'movie':
            ...
            links_scraper = scraper(
                    ...
                    timeout=timeout,
                    enable_debrid=allow_debrid)
        thread = workers.Thread(self.get_universalscrapers_sources, links_scraper,
                                progressDialog)
    ...
    def get_universalscrapers_sources(self, links_scraper, progressDialog):
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.rebirth.container.items'

        self.metaProperty = 'plugin.video.rebirth.container.meta'
