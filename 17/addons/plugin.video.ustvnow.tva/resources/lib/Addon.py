...
def add_directory(url_queries, title, img=ICON, fanart=FANART, total_items=0):
    ...
    if title == 'Movies' or title == 'Movies On Now' or title == 'Movies Later Today' or title == 'Upcoming Movies':
        img = addon.getAddonInfo('path') + '/resources/images/skins/' + get_setting('skin') + '/movies.png'
    if title == 'Sports' or title == 'Sports On Now' or title == 'Sports Later Today' or title == 'Upcoming Sports':
        img = addon.getAddonInfo('path') + '/resources/images/skins/' + get_setting('skin') + '/sports.png'
    if title == 'DVR' or title == 'Recordings' or title == 'Scheduled' or title == 'Recurring':
