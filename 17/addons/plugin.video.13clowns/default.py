...
elif action == 'collectionCars':
    from resources.lib.indexers import navigator
    navigator.navigator().collectionCars()
...
elif action == 'youtubexl':
    from resources.lib.indexers import navigator
    navigator.navigator().yt()
...
elif action == 'cartoonNavigator':
    from resources.lib.indexers import navigator
    navigator.navigator().cartoons()
