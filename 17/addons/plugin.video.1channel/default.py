...
def AddonMenu():  # homescreen
    ...
    if utils.has_upgraded():
        ...
        adn.setSetting('domain', 'http://www.primewire.is/')
...
def install_themes():
    ...
    query = {'mode': 'addoninstall', 'name': '1Channel.thempak',
             'url': 'https://github.com/kodibae/repository.kodibae/blob/master/script.1channel.themepak/script.1channel.themepak-0.0.8.zip?raw=true',
