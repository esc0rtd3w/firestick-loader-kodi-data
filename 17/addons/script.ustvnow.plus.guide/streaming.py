...
class StreamsService(object):
    def __init__(self, addon):
        path = xbmc.translatePath(os.path.join('special://profile', 'addon_data', 'script.ustvnow.plus.guide', 'addons.txt'))
        xbmc.log('[script.ustvnow.plus.guide] FTV addons.txt is used', xbmc.LOGDEBUG)
        ...
        try:
            ...
            print 'unable to parse addons.txt'
