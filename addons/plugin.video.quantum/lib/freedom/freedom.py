...
#            print 'parentalblockedpin',parentalblockedpin
            ...
            if showcontext == 'source':
                ...
                contextMenu.append(('Remove from Quantum Favorites','XBMC.RunPlugin(%s?mode=1906&name=%s)'
            ...
            if not name in FAV:
                contextMenu.append(('Add to Quantum Favorites','XBMC.RunPlugin(%s?mode=1905&name=%s&url=%s&iconimage=%s&fanart=%s&fav_mode=%s)'
...
#                print 'setting as folder in link'
        ...
        if showcontext:
            ...
            if showcontext == 'fav':
                contextMenu.append(
                    ('Remove from Quantum Favorites','XBMC.RunPlugin(%s?mode=1906&name=%s)'
                     %(sys.argv[0], urllib.quote_plus(name)))
                     )
                ...
                contextMenu.append(('Add to Quantum Favorites','XBMC.RunPlugin(%s)' %fav_params))
            liz.addContextMenuItems(contextMenu)
