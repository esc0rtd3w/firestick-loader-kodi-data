...
from resources.lib.modules import cleantitle,client,dom_parser,source_utils,cfscrape
...
class source:
    def __init__(self):
        ...
        self.base_link = 'https://www5.watchserieshd.io'
        self.search_link = 'search.html?keyword=%s'
        self.scraper = cfscrape.create_scraper()
        # watchserieshd.io and watchserieshd.co are the same
